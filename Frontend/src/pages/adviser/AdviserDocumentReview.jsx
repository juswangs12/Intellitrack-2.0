...
const AdviserDocumentReview = () => {
  ...
  const fetchSubmissions = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await apiService.getAdviserPendingSubmissions(user.id);
      setSubmissions(data || []);
    } catch (err) {
  ...
  return (
    <div className="fade-in">
      <div className="page-header">
        ...
        <p>Review assigned group submissions.</p>
      </div>
...
export default AdviserDocumentReview;